...
COMMAND commands[] = {
  ...
  { "view", com_view, "View the contexts of FILE" },
...
/* Attempt to complete on the contexts of TEXT.  START and END bound the
   region of rl_line_buffer that contains the word to complete.  TEXT is
   the word to complete.  We can use the entire contexts of rl_line_buffer
